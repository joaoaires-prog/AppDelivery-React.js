// src/Components/Mais1cafe.jsx

import React, { useState, useEffect } from 'react';
import { BsStarFill, BsStarHalf } from "react-icons/bs";
import Button from "../Layouts/Button"; // Componente Button
...
export default function Mais1cafe() {
  ...
  const RESTAURANTE_ID = 3; // ID para Mais1Café

  // Mapeamento de WhatsApp por Restaurante ID (HARDCODED AQUI)
  const whatsappNumbers = {
    1: "5561987654321", // PicaPau (ID 1)
    2: "5561912345678", // Apetitis (ID 2)
  ...
  // Função para lidar com o clique no botão "Encomendar agora"
    ...
    return (
      <div className="min-h-screen flex flex-col justify-center items-center lg:px-32 px-5">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Carregando cardápio do Mais1Café...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col justify-center items-center lg:px-32 px-5 text-red-600">
        <p>Erro ao carregar cardápio do Mais1Café: {error}</p>
            ...
            <SwiperSlide key={produto.id}>
              <div
                className="
                  ...
                  flex flex-col h-full /* Removido a duplicidade, deve estar aqui */
                  justify-between
                "
              >
                <img
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 mt-auto">
                    ...
                    {produto.disponivel ? (
                        <Button
                          ...
                          onClick={() => handleOrderClick(produto)} // <<< Aplicando onClick correto
                        />
                    ) : (
